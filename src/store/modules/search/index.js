...
const libraryReferenceSearchModule = {
  namespaced: true,
  state: () => ({
    ...INIT_STATE,
    advancedSearch: {
      ...INIT_STATE.advancedSearch,
      byIds: {
        ...INIT_STATE.advancedSearch.byIds,
        isEstonianReference: {
          ...INIT_STATE.advancedSearch.byIds.isEstonianReference,
          value: null
        }
      }
    }
...
export { libraryReferenceSearchModule };
